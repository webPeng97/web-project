    ...
    return (
      <Fragment>
        <div className="details">
          <div className="details-title">随着 JavaScript 单页应用开发日趋复杂</div>
          <p><Button type="primary" onClick={() => {this.props.history.goBack()}}>返回</Button>路由传参值：{this.props.match.params.id}</p>
